...
export class ItineraryController {
  ...
  async confirmMember(
    ...
    try {
      ...
      {
        return await this.itineraryService.addMember(
          payload.itineraryId,
          payload.userId,
        );
      }
